...
public abstract class CountableItemView extends ItemView {
	...
	if (amountText.getText().equals("") || Integer.parseInt(amountText.getText()) != getAmount()) {
	    if (getAmount() < 0)
		amountText.setText("");
	    else
	...
	amountText.setPosition(civ.getWidth() - font.getSpaceWidth() - font.getWidth(amountText.getText()), 
		civ.getHeight() - font.getLineHeight());
    }
