...
public class PartsManager {
	...
	parts.add(new Eye("wooden_eye", "глазной протез", 0f, 3f, 30));
	parts.add(new Eye("eye", "глаз", 1f, 1f, 1000));
	parts.add(new Eye("bionic_eye", "бионический глаз", 1.7f, 1.75f, 8000));
	...
	parts.add(new Leg("wooden_eye", "деревянная нога", 15f, .7f, 2.5f, 30));
	parts.add(new Leg("leg", "нога", 33f, 1.25f, 1f, 800));
	...
	parts.add(new Lungs("lungs", "легкие", 1f, 1f, 7000));
	parts.add(new Kidneys("kidneys", "почки", 1f, 1f, 5000));
	parts.add(new Heart("heart", "сердце", 1f, 1f, 8000));

	parts.add(new Brain("brain", "мозг", 1f, 1f, 14000));
	parts.add(new Brain("bionic_brain", "бионический мозг", 2.2f, 2.2f,
		8000));
	parts.add(new Brain("advanced_bionic_brain",
		"усиленный бионический мозг", 3.2f, 3.2f, 15000));
    }
