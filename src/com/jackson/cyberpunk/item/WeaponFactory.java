...
public class WeaponFactory {
	...
	case RUSTY_KNIFE:
	    ...
	    return new Weapon("rusty_knife", "Ржавый кинжал", 0, 1, 1, 2, 30, Weapon.Type.MELEE, helper);
	case MACHETE:
	    helper.add(new Pair(InjuryType.SCRATCH, .05f));
	    helper.add(new Pair(InjuryType.CUT, 1f));
	    return new Weapon("machete", "Мачете", 0, 2.5f, 1, 3, 100, Weapon.Type.MELEE, helper);
	case M16:
	    helper.add(new Pair(InjuryType.SHOT, 1f));
	    return new Weapon("m16", "M16", 40, 6f, 2, 4, 1000, Weapon.Type.GUN, helper);
